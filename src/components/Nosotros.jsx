  ...
  return (
    <div className="w-full bg-white rounded-b-[60px] md:rounded-b-[90px]">
      <section id="nosotros" className="max-w-[1425px] mx-auto px-4 pt-5 pb-12 lg:pb-25 text-(--oscuro)">
        ...
        <h2 className="relative inline-block pt-[30px] mb-[45px] md:pt-[50px] md:mb-[70px] text-[2rem] md:text-[45px] font-semibold after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2 after:-bottom-2.5 after:w-[90px] after:h-[5px] after:bg-(--naranja) after:rounded-sm">Sobre Nosotros</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-15 items-center">
          ...
          >
            <h3 className='w-[350px] bg-[linear-gradient(90deg,#fff0f0_0%,#ffffff_80%)] p-[12px_20px] rounded-xl border-l-4 border-l-(--naranja) text-2xl lg:text-3xl font-semibold mb-4 md:mb-5'>Nuestra Historia</h3>
